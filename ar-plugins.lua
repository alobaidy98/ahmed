...
local function run(msg, matches)
  ...
  if matches[1] == 'فعل ملف' and matches[3] == 'chat' then
  ...
  -- Enable a plugin
  if matches[1] == 'فعل ملف' and is_sudo(msg) then --after changed to moderator mode, set only sudo
  ...
  if matches[1] == 'عطل ملف' and matches[3] == 'chat' then
    local plugin = matches[2]
    local receiver = get_receiver(msg)
  ...
  -- Disable a plugin
  if matches[1] == 'عطل ملف' and is_sudo(msg) then --after changed to moderator mode, set only sudo
  ...
  if matches[1] == 'الملفات المشتغلة' and is_sudo(msg) then --after changed to moderator mode, set only sudo
    return reload_plugins(true)
  end
end
